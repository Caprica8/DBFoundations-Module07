...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_MelindaHull')
	 Begin 
	  Alter Database [Assignment07DB_MelindaHull] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_MelindaHull;
	 End
	Create Database Assignment07DB_MelindaHull;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_MelindaHull;
...
Select ProductName, Format(UnitPrice, 'C', 'en-US') as 'UnitPrice'
	...
	From vProducts Order by ProductName;
...
Create --Drop
View vCategoriesInventories 
  AS
Select dbo.vCategories.CategoryName, Format(InventoryDate, 'MMMM, yyyy') as 'InventoryDate', Sum(Count) as 'InventoryCountByCategory' 
...
Select * From vCategoriesInventories 
...
View  vProductInventoriesWithPreviousMonthCounts 
  AS
Select dbo.vProductInventories.ProductName, dbo.vProductInventories.InventoryDate, dbo.vProductInventories.InventoryCount, [PreviousMonthCount] = IIF(Year(InventoryDate) = '1996', 0, IsNull(Lag((InventoryCount)) Over (Partition by dbo.vProductInventories.ProductName Order by Month(dbo.vProductInventories.InventoryDate)),0))
	From dbo.vProductInventories
	Group by dbo.vProductInventories.ProductName, dbo.vProductInventories.InventoryDate, Month(dbo.vProductInventories.InventoryDate), dbo.vProductInventories.InventoryCount
go
...
View  vProductInventoriesWithPreviousMonthCountsWithKPIs 
  AS
Select ProductName, InventoryDate, InventoryCount, [PreviousMonthCount] = Lag(InventoryCount,1,0) Over (Partition by ProductName Order by Month(InventoryDate)), [QtyChangeKPI] = isNull (Case 
	...
	Group by ProductName, InventoryDate, Month(InventoryDate), InventoryCount, PreviousMonthCount
go
...
Function  dbo.fProductInventoriesWithPreviousMonthCountsWithKPIs (@KPI int)
  ...
  Return (Select Top 1000
		...
		ProductName, InventoryDate, InventoryCount, PreviousMonthCount, QtyChangeKPI
		...
		Order by 
			...
			Year(Cast(vProductInventoriesWithPreviousMonthCountsWithKPIs.InventoryDate as Date)));
go
